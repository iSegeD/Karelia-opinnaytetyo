      ...
      <div className="p-6 bg-white rounded shadow-lg">
        ...
        <form onSubmit={handleSubmit(handleCreateSubmit)}>
          ...
          <div className="flex justify-center my-6">
            <button
              type="submit"
              className="py-2 w-full sm:w-1/2 md:w-1/4 lg:w-1/6 text-white rounded bg-[#376bc0] hover:bg-[#2f5aad] transition-colors duration-300 ease-in-out cursor-pointer"
            >
              Create
            </button>
          </div>
